    ...
    <div class="container">
      ...
      <div class="table-responsive">
		...
		try
            ...
            <td><form action="view1.jsp" method="post"> <input  type="text"  name="dec" required="" > <input name="fid" type="hidden"  value="<%=rs.getString("fid") %>" required="" ></td>
          <td><input type="submit" value="Decrypt"></form></td>
           </tr>
